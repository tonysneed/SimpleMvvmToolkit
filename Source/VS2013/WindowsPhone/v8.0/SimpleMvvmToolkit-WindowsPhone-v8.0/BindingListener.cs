// EventToCommand is taken from MVVM Light Toolkit by Laurent Bugnion
// This is only needed for WP7 command support, because it appears that
// InvokeCommandAction from System.Windows.Interactivity is not supported in WP7
// ****************************************************************************
// ****************************************************************************
// <copyright file="BindingListener.cs" company="GalaSoft Laurent Bugnion">
...
namespace Expression.Samples.Interactivity.DataHelpers
{
    /// <summary>
