ReadMe for Simple Mvvm Toolkit Windows Store Project Template

NOTE: To use portable view models, you need to remove reference to
SimpleMvvmToolkit-WindowsStore, and add SimpleMvvmToolkit-Portable
